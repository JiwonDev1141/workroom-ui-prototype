			...
			<div class="col-lg-12 position-relative z-index-2">
				...
				<div class="row mt-4">
					<div class="col-lg-4 col-md-6 mt-4">
						<chart-holder-card title="مشاهدات الموقع" subtitle="آخر أداء للحملة" update="الحملة أرسلت قبل يومين">
							<reports-bar-chart
								:chart="{
					...
					<div class="col-lg-4 mt-4">
						<chart-holder-card title="المهام المكتملة" subtitle="آخر أداء للحملة" update="تم تحديثه للتو" color="dark">
							<reports-line-chart
								id="tasks-chart"
								:chart="{
									labels: [
